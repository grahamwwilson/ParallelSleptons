...
// Sun Oct 13 14:01:38 2019 by ROOT version 6.12/07
// from TTree KUAnalysis/KUAnalysis
// found on file: /home/t3-ku/crogan/NTUPLES/NANO/Fall17_94X/WJetsToLNu_HT-100To200_TuneCP5_13TeV-madgraphMLM-pythia8_Fall17_94X.root
//////////////////////////////////////////////////////////
...
myselector::myselector(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/t3-ku/crogan/NTUPLES/NANO/Fall17_94X/WJetsToLNu_HT-100To200_TuneCP5_13TeV-madgraphMLM-pythia8_Fall17_94X.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/t3-ku/crogan/NTUPLES/NANO/Fall17_94X/WJetsToLNu_HT-100To200_TuneCP5_13TeV-madgraphMLM-pythia8_Fall17_94X.root");
      }
...
Int_t myselector::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t myselector::LoadTree(Long64_t entry)
{
...
void myselector::Show(Long64_t entry)
{
...
Int_t myselector::Cut(Long64_t entry)
{
