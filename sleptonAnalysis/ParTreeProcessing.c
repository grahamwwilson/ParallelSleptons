...
int main(int argc, char *argv[])
{
   ...
   //load up the list of files to be processed. All the remaining 
   //input arguments are files to be added to the TChain
   std::vector<std::string_view> ifilelist{};
   //we need a regular string list to deal with SMS, can't get treenames
   //without c_strings and view can't be a cstr
  ...
  //if the treename is SMS we need to store all of the tree mass points 
  //and loop over the file list for every tree
